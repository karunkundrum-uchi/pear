...
begin
  ...
  set friend_label = normalized_username
  where friend_user_id = profile_id;
...
set friend_label = profile.username
from public.profiles profile
where connection.friend_user_id = profile.id
  and connection.friend_label <> profile.username;
